...
function Intro() {
    return (
        <div className='left-0 z-50 pt-3 flex flex-col items-center mt-auto sm:mt-10 '>
            <div className='text-4xl font-bold text-white font-serif p-5 rounded-lg text-center bg-black/50'>
